...
def assert_validation_error(actual: ValidationErrorSchema, expected: ValidationErrorSchema):
    """
    Verifies that validation error equals to expected value.

    :param actual: Actual error.
    :param expected: Expected error.
    :raises AssertionError: If at least one value dos not match.
    """
...
def assert_validation_error_response(actual: ValidationErrorResponseSchema,expected: ValidationErrorResponseSchema):
    """
    Verifies that API response object with validation errors (`ValidationErrorResponseSchema`)
    equals to expected.

    :param actual: Actual API response.
    :param expected: AExpected API response.
    :raises AssertionError: If values in responses do not match.
    """
...
def assert_internal_error_response(
    ...
    """
    Verifies internal errors (e.g. 404 (File not found)).
